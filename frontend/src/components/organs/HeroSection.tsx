...
// import HeroImg1 from "../../assets/rice/1.jpg"
import Rice from "../../assets/rice/2.jpg"
// import HeroImg3 from "../../assets/rice/3.jpg"
import { Texts } from "../particles/Data";
        ...
        <section className="w-full h-auto bg-gradient-to-r from-red-500 to-amber-500 relative overflow-x-hidden">
            ...
            <div className="flex justify-end lg:justify-start items-center gap-4 absolute lg:bottom-10 md:bottom-5 md:right-10 right-4 bottom-4">
                <Button
                    onClick={previous}
                    type="button"
                    className="w-8 h-8 border rounded-full border-green-500 flex items-center justify-center text-green-500 hover:text-green-400 hover:border-green-400"
                >
